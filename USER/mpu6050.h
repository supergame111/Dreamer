...
typedef struct _mpu6050
{
	...
	data_float acc_filter;
	data_float gyro_filter;

	data_float gyro_rad;	//弧度制
...
#define ACC_8G  4096  //8G量程模式下对应的最低有效位
#define ACC_2G  16384 //2G量程模式下的最低有效位 
...
void mpu6050_data_process(void);   //6050数据处理
